...
## Corpus Check
- 274 files · ~357,617 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1510 nodes · 4161 edges · 99 communities (89 shown, 10 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 83 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5f830ca`
...
Cohesion: 0.16
Nodes (11): CustomCursor(), PageTransition(), geistMono, instrumentSerif, metadata, industryNavItems, serviceNavGroups, team (+3 more)
...
Cohesion: 0.08
Nodes (29): AnalyticsEvent, AnalyticsEventProps, TrackProps, OutboundLinkTracker(), analyticsAllowed(), trackConversion(), trackLinkClick(), rec() (+21 more)
...
Cohesion: 0.28
Nodes (4): ArticleBody(), parseInlineLinks(), staticInsightCategories(), slugify()
...
Cohesion: 0.23
Nodes (11): CookieConsentContext, CookieConsentContextValue, buildConsent(), isRecord(), parseStoredConsent(), readStoredConsent(), writeStoredConsent(), CookieCategoryDefinition (+3 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (65): Author, InsightCategory, SiteSettings, Testimonial, fetchAllCaseStudiesFromSanity(), fetchAllFaqsFromSanity(), fetchAllIndustriesFromSanity(), fetchAllInsightCategoriesFromSanity() (+57 more)
...
Cohesion: 0.26
Nodes (11): getIndustryTitle(), getPostsBySlugs(), getServicesBySlugs(), caseStudyJsonLd(), InternalLinkGrid(), CaseStudyPage(), EntitySummary(), EntitySummaryField (+3 more)
...
Cohesion: 0.14
Nodes (17): FaqAccordionItem(), HeroWorkGallery(), HeroWorkGalleryProps, PortfolioHoverMedia(), PortfolioHoverMediaProps, REVEAL_SPRING, PortfolioImage(), PricingCardsSection() (+9 more)
...
Cohesion: 0.12
Nodes (14): ServiceMegaMenuCard, FeaturedInsightLink(), formatInsightDate(), IndustryMegaMenuGrid(), InsightsMegaMenuGrid(), LatestInsightLink(), MegaMenuProps, MigrationNavMenuItemLink() (+6 more)
...
Cohesion: 0.13
Nodes (27): articleJsonLd(), ArticleJsonLdInput, articlePageGraphJsonLd(), articleTocJsonLd(), articleUrl(), estimateWordCount(), HomepageGraphCaseStudy, HomepageGraphComparison (+19 more)
...
Cohesion: 0.10
Nodes (27): AlternativesIndexPage(), metadata, BlueprintGrid(), BlueprintGridProps, CompareIndexPage(), metadata, AlternativeGuide, alternatives (+19 more)
...
Cohesion: 0.20
Nodes (9): ArticleCard(), ArticleCardShowcaseBody(), formatDate(), ArticleTags(), FilterPost, InsightsFilterableGrid(), Tag(), TagVariant (+1 more)

### Community 36 - "Community 36"
Cohesion: 0.08
Nodes (15): caseStudies, faqs, customSoftwareGroups, allTags, caseStudiesByService, CATEGORY_ICONS, categoryTitles, client (+7 more)
...
Cohesion: 0.15
Nodes (27): Reveal(), RevealProps, Stagger(), StaggerProps, TextReveal(), TextRevealProps, migrations, metadata (+19 more)
...
Cohesion: 0.11
Nodes (21): ecommerceNavServices, portfolioProjects, products, applyTestimonialImageFallback(), CATEGORY_ORDER, enrichMigration(), getAllProducts(), getAllTestimonials() (+13 more)
...
Cohesion: 0.27
Nodes (7): CONTACT_INDUSTRY_OPTIONS, CONTACT_SERVICE_OPTIONS, ContactPrefill, services, BUDGET_OPTIONS, ContactInput, contactSchema

### Community 50 - "Community 50"
Cohesion: 0.09
Nodes (28): Migration, CustomSoftwareGroupSection, megaMenuNavLinks, NavMenuGroup, NavMenuItem, serviceMegaMenuCards, DIRECT_LINKS, LINKS_AFTER_INDUSTRIES (+20 more)
...
Cohesion: 0.18
Nodes (19): applyIndustryDetailOverride(), isIndustryParentRecord(), isIndustrySegment(), isNonEmptyCmsValue(), mergeIndustryRecord(), getCaseStudiesByIndustry(), getIndustryBySlug(), getIndustryPageData() (+11 more)
...
Cohesion: 0.10
Nodes (43): RootLayout(), HomePage(), metadata, PILLARS, sitemap(), STATIC_ROUTES, buildLlmsFullTxt(), CustomSoftwarePage() (+35 more)
...
Cohesion: 0.24
Nodes (9): POST(), findIndustryLabel(), findServiceLabel(), labelForIndustry(), labelForService(), defaultProfileLinks, siteSettings, labelForIndustry() (+1 more)

### Community 58 - "Community 58"
Cohesion: 0.11
Nodes (13): customSoftwareNavItems, brandWordmark, HomePreloader(), COMPANY_LINKS, CUSTOM_SOFTWARE_FOOTER, FooterNavLink(), HoverFlip(), Logo() (+5 more)

### Community 59 - "Community 59"
Cohesion: 0.21
Nodes (10): ArticleCover(), formatDate(), InsightsFeaturedArticle(), Navbar(), BEND_SPRING, HighlightRect, RubberHoverHighlightLayer(), RubberHoverOptions (+2 more)
...
Cohesion: 0.08
Nodes (17): ServiceGroup, CATEGORY_LABELS, CATEGORY_ORDER, FILTER_LABELS, FILTER_ORDER, FilterKey, PANEL_EASE, panelVariants (+9 more)
...
Cohesion: 0.17
Nodes (11): FAQ_CATEGORY_ORDER, FaqItem, groupFaqsByCategory(), homepageFaqs, FaqSection(), ArticleContinueReading(), buildIntro(), ContinueReadingCard() (+3 more)

### Community 67 - "Community 67"
Cohesion: 0.12
Nodes (18): cookiePolicyIntro, LegalDocument, LegalSection, privacyPolicyDocument, termsDocument, CookieSettingsPage(), metadata, LegalPageContent() (+10 more)
...
Cohesion: 0.14
Nodes (11): ArticleInlineCta(), ArticleQuickAnswer(), ArticleAudienceLine(), ArticleShare(), ArticleMobileToc(), ArticleSidebar(), ArticleSidebarProps, SidebarAccordionSection() (+3 more)
...
Cohesion: 0.13
Nodes (21): getAllCustomSoftware(), getAllCustomSoftwareSlugs(), getCaseStudyBySlug(), getCustomSoftwareBySlug(), getMigrationBySlug(), getServiceBySlug(), mergeCustomSoftware(), sanityClient (+13 more)
...
Cohesion: 0.18
Nodes (10): HOMEPAGE_PRICING_BADGES, HOMEPAGE_PRICING_SLUGS, HomepagePricingPackage, homepagePricingPackages, HomepagePricingSlug, ButtonAsButton, ButtonAsLink, CommonProps (+2 more)
...
Cohesion: 0.16
Nodes (10): agencyComparison, ComparisonRow, ComparisonSection, AgencyComparisonSection(), ComparisonTableRow(), MegaMenu(), BlueprintGuides(), BlueprintGuidesProps (+2 more)
...
Cohesion: 0.30
Nodes (8): useCookieConsent(), COOKIE_CATEGORIES, ConsentAwareAnalytics(), CookieBanner(), CookiePreferencesForm(), CookiePreferencesFormProps, preferencesFromConsent(), CookieSettingsPanel()

### Community 92 - "Community 92"
Cohesion: 0.11
Nodes (20): AUTHOR_SLUG_ALIASES, resolveAuthorSlugs(), InsightsPage(), getAdjacentPosts(), getAllInsightCategories(), getAllPosts(), getAuthor(), getFeaturedPost() (+12 more)

### Community 93 - "Community 93"
Cohesion: 0.29
Nodes (9): ContactPage(), metadata, STEPS, findProductLabel(), resolveContactPrefill(), getContactIndustryOptions(), getContactServiceOptions(), contactPageJsonLd() (+1 more)
...
Cohesion: 0.38
Nodes (5): buildLlmsTxt(), LlmsFullInput, CaseStudy, Service, GET()
...
- **Why does `cn()` connect `Community 26` to `Community 0`, `Community 6`, `Community 9`, `Community 17`, `Community 22`, `Community 28`, `Community 33`, `Community 34`, `Community 35`, `Community 38`, `Community 41`, `Community 43`, `Community 44`, `Community 49`, `Community 50`, `Community 53`, `Community 58`, `Community 59`, `Community 61`, `Community 62`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 73`, `Community 75`, `Community 79`, `Community 81`, `Community 85`, `Community 86`, `Community 91`, `Community 93`, `Community 95`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `fetchAuthorBySlugFromSanity()` connect `Community 92` to `Community 20`, `Community 47`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `customSoftwareItems` connect `Community 68` to `Community 36`, `Community 47`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
