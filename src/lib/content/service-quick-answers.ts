...
export const SERVICE_QUICK_ANSWERS: Record<string, ServiceQuickAnswer> = {
  ...
  "custom-in-house-software-for-smbs": {
    question: "What is custom in-house software for SMBs and why does a business need it?",
    shortAnswer:
      "Custom in-house software is purpose-built portals, dashboards, booking systems, and workflow tools that replace spreadsheets and email threads for SMB teams. Businesses need it when client status, internal ops, and reporting live in five disconnected tools. One owned system with role-based access gives your team one place to work and leadership one view of the business.",
  },
  "review-reputation": {
