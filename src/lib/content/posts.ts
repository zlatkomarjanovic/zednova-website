...
export const posts: Post[] = [
  {
    ...
    featured: true,
    accent: "#1c1917",
    tags: ["AI Overviews", "AEO", "SEO", "Generative Search", "Schema Markup"],
    seoTitle: "AI Overviews Are the New SEO — How to Get Cited (2026)",
    seoDescription:
      "Google AI Overviews, ChatGPT, and Perplexity now answer queries directly. Learn the 4 steps to get cited by answer engines instead of buried beneath them.",
    keywords: [
      "ai overviews",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "SEO optimizes to rank in the ten blue links. AEO (Answer Engine Optimization) optimizes to be cited by AI answer engines like Google AI Overviews, ChatGPT, and Perplexity. AEO rewards clean structure, schema markup, and answer-first content over keyword density.",
      },
      {
        id: "faq-llms-txt",
  ...
  },
  {
    ...
    featured: false,
    accent: "#262624",
    tags: ["Lead Response", "Revenue Leak Audit", "CRM", "Follow-Up", "Conversion"],
    seoTitle: "5-Minute Revenue Leak Audit for Small Businesses (2026)",
    seoDescription:
      "Most businesses lose 40% of leads to slow follow-up. Run this 5-minute audit — call your own business, submit your own form, check your last 20 estimates.",
    keywords: [
      "revenue leak audit",
      "lead follow up",
      "slow response leads",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Under five minutes. Studies consistently show that lead qualification drops by 80% after the first five minutes. If your contact form replies take hours, faster competitors are taking your leads every day.",
      },
      {
        id: "faq-fix-leak",
  ...
  },
  {
    ...
    featured: false,
    accent: "#1c1917",
    tags: ["Conversion", "Website Strategy", "CTA", "Page Speed", "Lead Capture"],
    seoTitle: "Why Your Website Is Losing Clients (It's Not the Design)",
    seoDescription:
      "Underperforming site? It's rarely the design. Learn the three real reasons websites lose clients — no single action, slow speed, and no capture system.",
    keywords: [
      "website not converting",
      "website conversion rate",
      "website losing clients",
      "one page one action",
  ...
  },
  {
    ...
    featured: false,
    accent: "#262624",
    tags: ["Website Rebuild", "CMS Migration", "Next.js", "Sanity", "Webflow"],
    seoTitle: "Rebuild vs Migrate Your Website: How to Decide (2026)",
    seoDescription:
      "Not every underperforming site needs a full rebuild. Use this framework to choose between migrate, refactor, or start fresh — with cost and timeline trade-offs.",
    keywords: [
      "rebuild vs migrate website",
