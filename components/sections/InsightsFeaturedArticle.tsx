  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="relative min-h-[40vh] lg:min-h-[60vh]"
        ...
        <div className="relative z-[1] flex flex-col justify-center gap-5 border-t border-zn-border p-6 md:p-10 lg:border-t-0 lg:border-l lg:p-12">
